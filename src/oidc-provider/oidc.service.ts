...
export class OidcService {
  ...
  constructor(
    ...
    // Démasque la vraie raison des erreurs du endpoint /token : oidc-provider renvoie au
    // client un message générique ("grant request is invalid"), mais error_detail porte la
    // cause réelle ("refresh token not found/expired/already used", "grant not found"...).
    // Clé pour comprendre les déconnexions liées au refresh.
